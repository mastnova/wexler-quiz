...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Quiz = __webpack_require__(205);
	...
	store.dispatch((0, _actions.fetchQuestions)());
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(52)(global || window || this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getNativeComponentFromComposite = __webpack_require__(197);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function user() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? localStorage.wexlerSession ? JSON.parse(localStorage.wexlerSession) : { currentQuestion: 1, answers: [], result: {} } : arguments[0];
	  var action = arguments[1];

	  var answers = [];
	  switch (action.type) {
	    case _actions.CHANGE_QUESTION:
	      return Object.assign({}, state, { currentQuestion: state.currentQuestion + 1 });
	    case _actions.SAVE_ANSWER:
	...
	function quizState() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? localStorage.quizState || 'not_started' : arguments[0];
	  var action = arguments[1];

	  switch (action.type) {
	    case _actions.START_QUIZ:
	      return 'in_progress';
	    case _actions.SHOW_RESULTS:
	      return 'ended';
	    default:
	      return state;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.SET_RESULT = exports.SHOW_RESULTS = exports.START_QUIZ = exports.SAVE_ANSWER = exports.CHANGE_QUESTION = exports.SET_QUESTIONS = undefined;
	...
	var CHANGE_QUESTION = exports.CHANGE_QUESTION = 'CHANGE_QUESTION';
	var SAVE_ANSWER = exports.SAVE_ANSWER = 'SAVE_ANSWER';
	var START_QUIZ = exports.START_QUIZ = 'START_QUIZ';
	...
	function fetchQuestions() {
	  return function (dispatch) {
	    (0, _isomorphicFetch2.default)('/api/questions').then(function (response) {
	      if (response.ok) {
	...
	function saveAnswer(questionId, answerId) {
	  return { type: SAVE_ANSWER, questionId: questionId, answerId: answerId };
	}
	...
	function fetchResult(answers) {
	  return function (dispatch) {
	    (0, _isomorphicFetch2.default)('api/result', {
	      method: 'POST',
	      headers: new Headers({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Question = __webpack_require__(206);

	var _Question2 = _interopRequireDefault(_Question);

	var _QuizBeginning = __webpack_require__(210);

	var _QuizBeginning2 = _interopRequireDefault(_QuizBeginning);

	var _QuizResults = __webpack_require__(211);
	...
	var Quiz = function (_Component) {
	  ...
	  _createClass(Quiz, [{
	    ...
	    value: function onClickStart() {
	      this.props.dispatch((0, _actions.startQuiz)());
	    }
	  }, {
	    key: 'getResult',
	    value: function getResult() {
	      this.props.dispatch((0, _actions.fetchResult)(this.props.answers));
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      switch (this.props.quizState) {
	        case 'not_started':
	          currentPage = _react2.default.createElement(_QuizBeginning2.default, { onClickStart: this.onClickStart.bind(this) });
	          break;
	        case 'in_progress':
	          currentPage = _react2.default.createElement(_Question2.default, null);
	          break;
	        case 'ended':
	          currentPage = _react2.default.createElement(_QuizResults2.default, {
	            getResult: this.getResult.bind(this),
	            result: this.props.result
	          });
	          break;
	        default:
	          currentPage = _react2.default.createElement(_QuizBeginning2.default, null);
	      }
	...
	Quiz.propTypes = {
	  ...
	  dispatch: _react.PropTypes.func.isRequired,
	  quizState: _react.PropTypes.string.isRequired,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _QuestionHeader = __webpack_require__(207);

	var _QuestionHeader2 = _interopRequireDefault(_QuestionHeader);

	var _QuestionText = __webpack_require__(208);

	var _QuestionText2 = _interopRequireDefault(_QuestionText);

	var _QuestionAnswers = __webpack_require__(209);

	var _QuestionAnswers2 = _interopRequireDefault(_QuestionAnswers);
	...
	var Question = function (_Component) {
	  ...
	  _createClass(Question, [{
	    key: 'onChangeRadio',
	    value: function onChangeRadio(id) {
	      this.setState({
	        activeRadioId: id
	      });
	    }
	    ...
	    value: function onClickAccept() {
	      ...
	      var answerId = this.state.activeRadioId;
	      var numberOfQuestions = this.props.numberOfQuestions;

	      this.props.dispatch((0, _actions.saveAnswer)(questionId, answerId));
	      if (numberOfQuestions === questionId) {
	        this.props.dispatch((0, _actions.showResults)());
	      } else {
	        this.props.dispatch((0, _actions.changeQuestion)());
	      }
	      this.setState({
	        activeRadioId: null
	      });
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'question' },
	        _react2.default.createElement(_QuestionHeader2.default, { id: this.props.id }),
	        _react2.default.createElement(_QuestionText2.default, { text: this.props.text }),
	        _react2.default.createElement(_QuestionAnswers2.default, {
	...
	Question.propTypes = {
	  answers: _react.PropTypes.array,
	  dispatch: _react.PropTypes.func,
	  id: _react.PropTypes.number,
	  numberOfQuestions: _react.PropTypes.number,
	  text: _react.PropTypes.string
	};

	var mapStateToProps = function mapStateToProps(state) {
	  var questionList = state.questions;
	  var currentQuestionId = state.user.currentQuestion;
	  var filteredList = questionList.filter(function (element) {
	    if (element.id === currentQuestionId) {
	      return 1;
	    }
	    return 0;
	  });
	  var question = filteredList[0] || {};
	  return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QuestionHeader = function (_Component) {
	  _inherits(QuestionHeader, _Component);

	  function QuestionHeader() {
	    _classCallCheck(this, QuestionHeader);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(QuestionHeader).apply(this, arguments));
	  }
	  ...
	  _createClass(QuestionHeader, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        "div",
	        { className: "question__question-header" },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QuestionText = function (_Component) {
	  _inherits(QuestionText, _Component);

	  function QuestionText() {
	    _classCallCheck(this, QuestionText);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(QuestionText).apply(this, arguments));
	  }

	  _createClass(QuestionText, [{
	    key: "render",
	    value: function render() {
	      return _react2.default.createElement(
	        "div",
	        { className: "question__question-text" },
	        this.props.text
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QuestionAnswers = function (_Component) {
	  _inherits(QuestionAnswers, _Component);

	  function QuestionAnswers() {
	    _classCallCheck(this, QuestionAnswers);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(QuestionAnswers).apply(this, arguments));
	  }

	  _createClass(QuestionAnswers, [{
	    key: "render",
	    value: function render() {
	      var _this2 = this;
	          ...
	          return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement("input", {
	                checked: answer.id === _this2.props.activeId ? 'checked' : '',
	                name: "answer",
	                onChange: function onChange() {
	                  return _this2.props.onChangeRadio(answer.id);
	                },
	                type: "radio",
	                value: answer.id
	              }),
	...
	QuestionAnswers.propTypes = {
	  activeId: _react.PropTypes.number,
	  answers: _react.PropTypes.array,
	  onChangeRadio: _react.PropTypes.func
	};

	exports.default = QuestionAnswers;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QuizBeginning = function (_Component) {
	  _inherits(QuizBeginning, _Component);

	  function QuizBeginning() {
	    _classCallCheck(this, QuizBeginning);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(QuizBeginning).apply(this, arguments));
	  }

	  _createClass(QuizBeginning, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	  ...
	  return QuizBeginning;
	}(_react.Component);

	QuizBeginning.propTypes = {
	  onClickStart: _react.PropTypes.func.isRequired
	};

	exports.default = QuizBeginning;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QuizResults = function (_Component) {
	  _inherits(QuizResults, _Component);

	  function QuizResults() {
	    _classCallCheck(this, QuizResults);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(QuizResults).apply(this, arguments));
	  }
	...
	QuizResults.propTypes = {
	  getResult: _react.PropTypes.func.isRequired,
